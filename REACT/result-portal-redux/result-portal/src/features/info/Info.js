...
import { selectedSeason, selectedProgramme, selectedYear, semesterCount, selectedType} from './infoSlice'
...
function Info({showDouble}) {
   ...
   return (
        <Container>
            <CourseTypeContainer>
            <h4>Course</h4>
            <select name="" id="programmeType" value={info.type} onChange={(e) => dispatch(selectedType(e.target.value))}>
                <option value="Computer Science">Computer Science</option>
                <option value="Computer Engineering">Computer Engineering</option>
                <option value="Information System">Information System </option>
                <option value="Intelligent Systems Engineering">Intelligent Systems Engineering</option>
